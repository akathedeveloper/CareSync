    ...
    <nav className="fixed top-0 w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border-b border-gray-200/50 dark:border-gray-800/50 z-50 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <a key="Home" href="#home" aria-label="Go to Home">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {menuItems.map((item) => (
              <a
                key={item}
                href={
                  item === "Contact" ? "#contact-form" : `#${item.toLowerCase()}`
                }
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="relative md:hidden" id="mobile-menu" ref={mobileMenuRef}>
          <div
            className="absolute right-0 w-52 h-dvh pt-10 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-800"
            role="menu"
